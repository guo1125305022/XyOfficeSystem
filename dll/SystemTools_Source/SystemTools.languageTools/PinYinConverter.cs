namespace SystemTools.languageTools
{
    using System;
    using System.Text;
    ...
    public class PinYinConverter
    {
        ...
        public static unsafe string Get(char ch)
        {
            byte[] buffer;
            int num;
            bool flag;
            ...
            goto Label_01AA;
        Label_001D:
            if (((char.IsPunctuation(ch) != null) ? 1 : char.IsSeparator(ch)) == null)
            {
                goto Label_0041;
            }
            str = &ch.ToString();
        ...
        Label_0041:
            ...
            goto Label_01AA;
        Label_0067:
            buffer = Encoding.GetEncoding("gb2312").GetBytes(&ch.ToString());
            num = ((buffer[0] * 0x100) + buffer[1]) - 0x10000;
            if (((num <= 0) ? 0 : (num < 160)) == null)
            {
                goto Label_00B4;
            }
            str = &ch.ToString();
        ...
        Label_0167:
            goto Label_01A2;
        Label_016A:
            num5 = Array.IndexOf<string>(otherChinese, &ch.ToString());
            if ((num5 != decimal.MinusOne) == null)
            {
                goto Label_01A1;
            }
            str = otherPinYin[num5];
            goto Label_01AA;
        Label_01A1:;
        Label_01A2:
            str = string.Empty;
        ...
        public static string Get(string str)
        {
            ...
            goto Label_005C;
        Label_0013:
            builder = new StringBuilder(str.Length * 10);
            chArray = str.ToCharArray();
            num = 0;
            goto Label_0046;
        Label_002E:
            builder.Append(Get(chArray[num]));
            num += 1;
        Label_0046:
            if ((num < ((int) chArray.Length)) != null)
            {
                goto Label_002E;
            }
        ...
        Label_0013:
            ...
            goto Label_0045;
        Label_002D:
            builder.Append(GetFirst(chArray[num]));
            num += 1;
        Label_0045:
            if ((num < ((int) chArray.Length)) != null)
            {
