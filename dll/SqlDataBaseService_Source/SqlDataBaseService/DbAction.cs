namespace SqlDataBaseService
{
    ...
    {
        private static SqlDataBaseService.DbAction db;
        private Dictionary<string, SqlDataBaseService.ConnectInfo> dictionary;
        private static SqlDataBaseService.DbAction lockeObject;

        static DbAction()
        {
            lockeObject = new SqlDataBaseService.DbAction();
            return;
        }
        ...
        {
            base..ctor();
            this.dictionary = new Dictionary<string, SqlDataBaseService.ConnectInfo>();
            return;
        }
